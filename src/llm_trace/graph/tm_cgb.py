"""Temporal Multimodal Contrastive Graph Booster."""
...
class TemporalMultimodalContrastiveGraphBooster:
    ...
    It preserves the manuscript's graph types, edge categories, and
    evidence-preserving perturbation interface.
    """

    def __init__(self, config: dict) -> None:
        self.config = config
        self.graph_encoder = RelationAwareGraphEncoder(
            hidden_dim=int(config.get("graph_hidden_dim", 768)),
            edge_types=list(config.get("edge_types", [])),
